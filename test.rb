...
round = event.new_round [1,7,16,24,50,79]
round.add_judges ["A", "B", "C"]
round.number_recalled = 6

round.add_recalls "A", :cha, [1,7,16,24,50,79]
round.add_recalls "B", :cha, [1,7,16,24,50,79]
round.add_recalls "C", :cha, [1,7,16,24,50,79]
round.add_recalls "A", :jive, [1,7,16,24,50,79]
